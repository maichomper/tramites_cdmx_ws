...
AS
SELECT id_cat_ente, nombre, calle_numero,Del.descripcion AS delegacion, Col.colonia AS colonia, cp, telefono_1, ext_1, telefono_2, ext_2, url_ubicacion, area_atencion_ts.id_area_atencion_ts 
